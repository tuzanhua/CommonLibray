...
public class ThreadPool {
    ...
    private static int corePoolSize = count;            //核心池的大小 运行线程的最大值 当线程池中的线程数目达到corePoolSize后，就会把多余的任务放到缓存队列当中；
    private static int maximumPoolSize = count;        //创建线程最大值
     ...
     * @return
     */
    public static ThreadPool init(int count) {
        corePoolSize = count;
